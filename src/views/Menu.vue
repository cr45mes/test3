<template>
  <div class="user-manage">
    ...
    <el-dialog title="创建菜单" v-model="showModal">
      <el-form ref="dialogForm" :model="menuForm" label-width="150px" :rules="rules">
        <el-form-item label="父级菜单" prop="parentId">
          <el-cascader placeholder="请选择父级菜单" v-model="menuForm.parentId" :options="menuList" :props="{ checkStrictly: true, value: '_id', label: 'menuName' }" clearable />
